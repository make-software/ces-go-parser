...
func (m *MockClient) QueryBalance(ctx context.Context, identifier rpc.PurseIdentifier) (rpc.QueryBalanceResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryBalance", ctx, identifier)
...
func (mr *MockClientMockRecorder) QueryBalance(ctx, identifier interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryBalance", reflect.TypeOf((*MockClient)(nil).QueryBalance), ctx, identifier)
}
